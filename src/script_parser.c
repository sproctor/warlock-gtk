...
#define yyparse         scriptparse
#define yylex           scriptlex
#define yyerror         scripterror
#define yylval          scriptlval
#define yychar          scriptchar
#define yydebug         scriptdebug
#define yynerrs         scriptnerrs
...
{
       0,     0,     3,     5,     7,    10,    13,    15,    18,    23,
      25,    26,    29,    31,    33,    37,    41,    44,    48
};

/* YYRHS -- A `-1'-separated list of the rules' RHS.  */
static const yytype_int8 yyrhs[] =
{
      17,     0,    -1,    18,    -1,     7,    -1,    19,     7,    -1,
...
{
       0,    72,    72,    78,    83,    84,    91,    93,   104,   109,
     116,   117,   121,   123,   129,   131,   140,   148,   157
};
#endif
...
static const char *const yytname[] =
{
  ...
  "SCRIPT_THEN", "SCRIPT_OPEN_PAREN", "SCRIPT_CLOSE_PAREN",
  "SCRIPT_BINARY_OP", "SCRIPT_UNARY_OP", "SCRIPT_COMPARE_OP",
  "SCRIPT_TEST_OP", "$accept", "parser", "line", "exp", "command",
  "arg_list", "script_data", "conditional", 0
};
#endif
...
{
       0,    16,    17,    18,    18,    18,    19,    19,    19,    20,
      21,    21,    22,    22,    23,    23,    23,    23,    23
};
  ...
  if (yydebug)								  \
    {									  \
      ...
      yy_symbol_print (stderr,						  \
		  Type, Value, command, label, line_number); \
      YYFPRINTF (stderr, "\n");						  \
    }									  \
} while (YYID (0))
...
/*ARGSUSED*/
     ...
     || defined __cplusplus || defined _MSC_VER)
static void
yy_symbol_value_print (FILE *yyoutput, int yytype, YYSTYPE const * const yyvaluep, ScriptCommand **command, const char **label, int line_number)
#else
static void
yy_symbol_value_print (yyoutput, yytype, yyvaluep, command, label, line_number)
    FILE *yyoutput;
    int yytype;
...
`--------------------------------*/
     ...
     || defined __cplusplus || defined _MSC_VER)
static void
yy_symbol_print (FILE *yyoutput, int yytype, YYSTYPE const * const yyvaluep, ScriptCommand **command, const char **label, int line_number)
#else
static void
yy_symbol_print (yyoutput, yytype, yyvaluep, command, label, line_number)
    FILE *yyoutput;
    int yytype;
    YYSTYPE const * const yyvaluep;
    ScriptCommand **command;
...
`------------------------------------------------*/
     ...
     || defined __cplusplus || defined _MSC_VER)
static void
yy_reduce_print (YYSTYPE *yyvsp, int yyrule, ScriptCommand **command, const char **label, int line_number)
#else
static void
yy_reduce_print (yyvsp, yyrule, command, label, line_number)
    YYSTYPE *yyvsp;
    int yyrule;
    ScriptCommand **command;
    const char **label;
...
do {					\
  if (yydebug)				\
    yy_reduce_print (yyvsp, Rule, command, label, line_number); \
} while (YYID (0))
...
/*ARGSUSED*/
     ...
     || defined __cplusplus || defined _MSC_VER)
static void
yydestruct (const char *yymsg, int yytype, YYSTYPE *yyvaluep, ScriptCommand **command, const char **label, int line_number)
#else
static void
yydestruct (yymsg, yytype, yyvaluep, command, label, line_number)
    const char *yymsg;
    int yytype;
    YYSTYPE *yyvaluep;
    ScriptCommand **command;
...
#line 72 "script_parser.y"
    {
		(yyvsp[(1) - (1)].command)->line_number = line_number;
		*command = (yyvsp[(1) - (1)].command);
		YYACCEPT; }
    break;
...
#line 78 "script_parser.y"
    {
		...
		(yyval.command)->conditionals = NULL;
...
#line 93 "script_parser.y"
    {
		...
		(yyvsp[(2) - (2)].command)->conditionals = g_list_append ((yyvsp[(2) - (2)].command)->conditionals, conditional);
		(yyval.command) = (yyvsp[(2) - (2)].command); }
    break;
...
#line 131 "script_parser.y"
    {
		...
		expr->op = (yyvsp[(2) - (3)].binary_op);
		expr->lhs = (yyvsp[(1) - (3)].conditional);
		expr->rhs = (yyvsp[(3) - (3)].conditional);
...
/* Line 1806 of yacc.c  */
#line 140 "script_parser.y"
    {
		ScriptUnaryExpr *expr;
		expr = g_new (ScriptUnaryExpr, 1);
		expr->op = (yyvsp[(1) - (2)].unary_op);
		expr->rhs = (yyvsp[(2) - (2)].conditional);
		(yyval.conditional) = g_new (ScriptConditional, 1);
...
# define YYSYNTAX_ERROR yysyntax_error (&yymsg_alloc, &yymsg, \
                                        yyssp, yytoken)
      {
        ...
        yyerror (command, label, line_number, yymsgp);
  ...
  if (yyerrstatus == 3)
      ...
      else
	{
	  yydestruct ("Error: discarding",
		      yytoken, &yylval, command, label, line_number);
	  yychar = YYEMPTY;
	}
    }
  ...
  for (;;)
	...
	YYABORT;
      ...
      yydestruct ("Error: popping",
		  yystos[yystate], yyvsp, command, label, line_number);
      YYPOPSTACK (1);
      yystate = *yyssp;
      YY_STACK_PRINT (yyss, yyssp);
    }
  ...
  while (yyssp != yyss)
    {
      yydestruct ("Cleanup: popping",
		  yystos[*yyssp], yyvsp, command, label, line_number);
      YYPOPSTACK (1);
    }
#ifndef yyoverflow
  if (yyss != yyssa)
